        ...
        fetch("/category/getprodbycid", requestOptions).then((res) => {return res.json();}).then((data) => {
          ...
          for(let i=0;i<productGroups.length;i++){
            ...
            for(let j=0;j<chunk.length;j++){ 
              carouselInner =    '<div class="col-md-6 col-lg-4 mb-4 mb-md-0"><div class="card text-black" ><img style="max-height:300px ; max-width:400px;" src="/public/pics/'+chunk[j].Url+'" class="card-img-top" /><div class="card-body"><div class="text-center"><h4 class="card-title">'+chunk[j].ProdName+'</h4><h6 class="display-5 fw-bolder" style="font-size:25px;" >'+chunk[j].Price+'₪ </h6></div><div class="text-center"><div class="d-flex flex-column mb-4"></div> <a class="btn btn-outline-dark mt-auto" href="/product/prodpage?sku='+chunk[j].Sku+'" style="text-decoration: none;">בקרו אותי</a></div><div class="d-flex flex-row"></div></div></div></div>';
